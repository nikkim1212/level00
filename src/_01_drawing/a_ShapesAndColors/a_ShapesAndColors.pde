...
//    The ellipse command looks like this:      
 ellipse(350,350,180,180);  // middle circle
 ellipse(350,195,130, 130); //top circle
 ellipse(350,565,250,250);  //bottom circle
 
 fill(#000000);
 
 ellipse(350,350,25,25);  // middle button
 ellipse(350,400,25,25);  // bottom button
 ellipse(350,300,25,25);  // top button
 
 ellipse(325,190,25,25); 
